...
export default function ForgotPasswordPage() {
        ...
        <form onSubmit={handleResetPassword} className="mt-7 space-y-4">
          <div>
            ...
            <input
              ...
              autoFocus
              className="mt-1.5 w-full rounded-lg border border-line px-3.5 py-3 text-center font-mono text-lg tracking-[0.3em] outline-none transition-colors focus:border-ink"
            />
          </div>
          <div>
  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleRequestCode} className="mt-7 space-y-4">
        <div>
